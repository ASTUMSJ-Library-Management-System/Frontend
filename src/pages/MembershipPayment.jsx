...
const MembershipPayment = () => {
  ...
  // Determine current status based on latest payment
  const currentStatus = paymentHistory.length
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      const newPayment = {
        id: Date.now(),
        description: `Membership Fee - ${new Date().toLocaleString("default", {
          month: "long",
          year: "numeric",
        })}`,
                  ...
                  >
                    <div>
                      ...
                      <p className="text-xs text-[#189966]">
                        Submitted: {new Date(payment.date).toLocaleDateString()}
                      </p>
                    </div>
                    <span
